...
/**
 * WP_Garrigan_Lyman class. This class should ideally be used to work with the
 * public-facing side of the WordPress site.
 *
 * If you're interested in introducing administrative or dashboard
 * functionality, then refer to `class-wp-garrigan-lyman-admin.php`
 *
 * @package WP_Garrigan_Lyman
 * @author  tonyjohnston <tony.johnston@glg.com>
 */
class WP_Garrigan_Lyman {
	 ...
	 * @var      string
	 */
	protected $plugin_slug = 'wp-garrigan-lyman';
	...
	private function __construct() {
		 ...
		 *
                ...
                add_action( 'init', array( $this, 'action_register_cpts' ));
	...
	public function enqueue_scripts() {
		wp_enqueue_script( $this->plugin_slug . '-plugin-script', plugins_url( 'assets/js/public.js', __FILE__ ), array( 'jquery' ), self::VERSION );
                wp_localize_script( $this->plugin_slug . '-plugin-script', 'wp_ajax', array( 'ajaxurl' => admin_url( 'admin-ajax.php' ) ) ); // setting ajaxurl
	}
	 ...
	 * @since   1.0.0
	 */
	public function action_register_cpts(){
